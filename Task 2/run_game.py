...
class GameRunner:
    ...
    def setup_player(self, player_class, player_color):
        ...
        """
        try:
            player, measured_time = utils.run_with_limited_time(player_class, (self.setup_time, player_color, self.time_per_k_turns, self.k), {}, self.setup_time * 1.5)
        except MemoryError:
            return True
    ...
    def run(self):
        ...
        while True:
            ...
            try:
                ...
                move, run_time = utils.run_with_limited_time(player.get_move, (copy.deepcopy(board_state), possible_moves), {}, remaining_run_time * 1.5)
